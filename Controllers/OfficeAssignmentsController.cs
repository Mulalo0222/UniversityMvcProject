...
namespace UniversityMvcProject.Controllers
{
    public class OfficeAssignmentsController : Controller
    {
        ...
        {
            var officeAssignments = db.OfficeAssignments.Include(o => o.Lecturer);
        ...
        public ActionResult Create([Bind(Include = "LecturerID,Location")] OfficeAssignment officeAssignment)
        {
            ...
            ViewBag.LecturerID = new SelectList(db.Lecturers, "ID", "LastName", officeAssignment.LecturerID);
            return View(officeAssignment);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "LecturerID,Location")] OfficeAssignment officeAssignment)
        {
            if (ModelState.IsValid)
            {
